        ...
        <SafeAreaView className="flex-1 bg-gray-900">
          ...
          >
            <Text className="text-white text-base leading-6 mb-4">
              <Text className="font-bold">Dernière mise à jour :</Text> 24 mai
              2025
            </Text>
            ...
            <Text className="text-gray-300 text-sm leading-6 mb-6">
              ...
              informe de vos droits à la confidentialité et de la façon dont la
              loi vous protège.
            </Text>
            ...
            <View className="mb-6">
              ...
              <Text className="text-gray-300 text-sm leading-5 mb-4">
                • Adresse e-mail{"\n"}• Numéro de téléphone{"\n"}• Adresse,
                État, Province, Code postal, Ville{"\n"}• Données d'utilisation
              </Text>
            </View>
            ...
            <View className="mb-6">
              ...
              <Text className="text-gray-300 text-sm leading-5 mb-4">
                Avec votre permission préalable, nous pouvons collecter des
                informations concernant votre localisation pour fournir les
            ...
            <View className="mb-6">
              ...
              <Text className="text-gray-300 text-sm leading-5 mb-4">
                ...
                visitées et temps passé{"\n"}• Identifiants uniques de
        ...
        <View className="flex-1 p-6">
          ...
          <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
            ...
            <Text className="text-gray-300 text-base leading-6 mb-6">
              Nous respectons votre vie privée et sommes transparents sur la
              façon dont nous utilisons vos données pour vous offrir la
              meilleure expérience de livraison de nourriture.
            </Text>
            ...
            <View className="mb-6">
              ...
              <Text className="text-gray-300 text-sm leading-5 mb-4">
                ...
                techniques{"\n"}• Analyser les tendances pour de meilleures
                offres
              </Text>
            </View>
            ...
            <View className="bg-blue-900/30 p-4 rounded-lg mb-6">
              ...
              <Text className="text-gray-300 text-sm leading-5">
                Cette demande respecte les exigences d'Apple pour la
                transparence du suivi des applications (ATT). Votre choix sera
                respecté et peut être modifié dans les paramètres iOS.
              </Text>
            </View>
            ...
            <View className="bg-gray-800 p-4 rounded-lg mb-6">
              ...
              <Text className="text-gray-300 text-sm">
                ...
                Site: https://Afood.ma{"\n"}
                {"\n"}
                Pour toute question sur vos données ou cette politique de
                confidentialité.
              </Text>
            </View>
          </ScrollView>
