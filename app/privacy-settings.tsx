...
import { requestTrackingPermission, getTrackingPermissionStatus } from '@/utils/trackingPermission';
...
export default function PrivacySettingsScreen() {
    ...
    const handleMarketingToggle = async (enabled) => {
        ...
        await AsyncStorage.setItem(STORAGE_KEYS.MARKETING_ENABLED, enabled.toString());

        Alert.alert(
            enabled ? 'Communications marketing activées' : 'Communications marketing désactivées',
            enabled
            ...
            <ScrollView className="flex-1">
                ...
                <View className="bg-white mx-4 mt-4 rounded-xl p-4 shadow-sm">
                    ...
                    <Text className="text-gray-600 text-sm leading-5">
                        Contrôlez comment vos données sont utilisées et partagées. Vous pouvez modifier ces paramètres à tout moment.
                    </Text>
                </View>
                ...
                <View className="bg-white mx-4 mt-4 rounded-xl shadow-sm">
                    <View className="p-4 border-b border-gray-100">
                        ...
                        <Text className="text-gray-600 text-sm mb-3">
                            Permet aux apps de suivre votre activité pour personnaliser les publicités.
                        </Text>

                        <View className="flex-row items-center justify-between">
                            <View className="flex-1">
                                <Text className="text-gray-800 font-medium">Autoriser le suivi</Text>
                                <Text className="text-gray-500 text-xs mt-1">
                                    Statut: <Text style={{ color: getTrackingStatusColor() }}>
                ...
                <View className="bg-white mx-4 mt-4 rounded-xl shadow-sm">
                    <View className="p-4 border-b border-gray-100">
                        ...
                        <Text className="text-gray-600 text-sm mb-3">
                            Aide à améliorer l'application en analysant l'utilisation (données anonymisées).
                        </Text>

                        <View className="flex-row items-center justify-between">
                            <View className="flex-1">
                                <Text className="text-gray-800 font-medium">Partager les analytics</Text>
                                <Text className="text-gray-500 text-xs mt-1">
                ...
                <View className="bg-white mx-4 mt-4 rounded-xl shadow-sm">
                    <View className="p-4 border-b border-gray-100">
                        ...
                        <View className="flex-row items-center justify-between">
                            <View className="flex-1">
                                <Text className="text-gray-800 font-medium">Recevoir les offres</Text>
                                <Text className="text-gray-500 text-xs mt-1">
                ...
                <View className="bg-white mx-4 mt-4 rounded-xl shadow-sm">
                    ...
                    >
                        ...
                        <View className="flex-1">
                            <Text className="text-gray-800 font-medium">Politique de confidentialité</Text>
                            <Text className="text-gray-500 text-sm">Lire la politique complète</Text>
                        </View>
                    ...
                    >
                        ...
                        <View className="flex-1">
                            ...
                            <Text className="text-gray-500 text-sm">Supprime toutes vos données</Text>
                        </View>
                    ...
                    >
                        ...
                        <View className="flex-1">
                            <Text className="text-gray-800 font-medium">Réinitialiser les paramètres</Text>
                            <Text className="text-gray-500 text-sm">Revenir aux paramètres par défaut</Text>
                        </View>
                ...
                <View className="bg-white mx-4 mt-4 mb-8 rounded-xl p-4 shadow-sm">
                    ...
                    <Text className="text-gray-600 text-sm mb-3">
                        Contactez-nous pour toute question concernant vos données personnelles.
                    </Text>
