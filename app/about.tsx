...
export default function AboutScreen() {
    ...
    const openPrivacyPolicy = () => {
        Linking.openURL('https://dixie.ma/privacy');
    };

    const openTermsOfService = () => {
        Linking.openURL('https://dixie.ma/terms');
    };
    ...
    const teamMembers = [
        {
            ...
            description: 'Passionnés par la livraison de nourriture et la technologie'
        }
    ];
            ...
            <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
                ...
                <View className="bg-white mx-4 mt-4 rounded-xl p-6 shadow-sm items-center">
                    ...
                    <Text className="text-gray-600 text-center mb-4">
                        Application de livraison pour les livreurs partenaires de Dixie
                    </Text>
                ...
                <View className="bg-white mx-4 mt-4 rounded-xl p-4 shadow-sm">
                    ...
                    <Text className="text-gray-600 text-sm leading-6">
                        Chez Dixie, nous connectons les livreurs avec les restaurants et les clients pour créer
                        un écosystème de livraison efficace et fiable. Notre mission est de faciliter la vie
                        des livreurs tout en garantissant une expérience exceptionnelle aux clients.
                    </Text>
                </View>
                ...
                <View className="bg-white mx-4 mt-4 rounded-xl shadow-sm">
                    ...
                    {features.map((feature, index) => (
                        <View
                            key={index}
                            className={`flex-row p-4 ${index < features.length - 1 ? 'border-b border-gray-100' : ''}`}
                        >
                ...
                <View className="bg-white mx-4 mt-4 rounded-xl shadow-sm">
                    ...
                    <View className="px-4 pb-4">
                        ...
                        >
                            ...
                            <Text className="text-orange-500 ml-2">https://dixie.ma</Text>
                        </TouchableOpacity>
                ...
                <View className="bg-white mx-4 mt-4 rounded-xl shadow-sm">
                    ...
                    >
                        <View className="flex-row items-center">
                            ...
                            <Text className="text-gray-800 ml-3">Politique de confidentialité</Text>
                        </View>
                    ...
                    >
                        <View className="flex-row items-center">
                            ...
                            <Text className="text-gray-800 ml-3">Conditions d'utilisation</Text>
                        </View>
                        <Feather name="external-link" size={16} color="#9CA3AF" />
                    </TouchableOpacity>
                    ...
                    >
                        <View className="flex-row items-center">
                            ...
                            <Text className="text-gray-800 ml-3">Paramètres de confidentialité</Text>
                        </View>
                ...
                <View className="bg-white mx-4 mt-4 mb-8 rounded-xl p-4 shadow-sm">
                    ...
                    <Text className="text-gray-600 text-sm leading-6">
                        Application développée avec React Native et Expo.
                        Utilise Firebase pour la base de données, Google Maps pour la géolocalisation,
                        et Stripe pour les paiements. Conçue pour offrir une expérience native
                        sur iOS et Android.
                    </Text>

                    <View className="mt-4 pt-4 border-t border-gray-100">
                        <Text className="text-gray-500 text-xs text-center">
                            © 2024 Dixie. Tous droits réservés.
                        </Text>
