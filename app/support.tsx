...
export default function SupportScreen() {
    ...
    const contactMethods = [
        {
            ...
            action: () => Linking.openURL('mailto:oumzil@gmail.com?subject=Support Dixie Delivery')
        },
        {
            id: 'website',
            title: 'Site Web',
            ...
            action: () => Linking.openURL('https://dixie.ma/support')
        },
        {
            id: 'whatsapp',
            title: 'WhatsApp',
            ...
            action: () => Linking.openURL('https://wa.me/212600000000?text=Bonjour, j\'ai besoin d\'aide avec l\'app Dixie Delivery')
        }
    ];
    ...
    const faqData = [
        {
            id: 1,
            question: 'Comment commencer à livrer avec Dixie ?',
            answer: 'Pour commencer à livrer, vous devez d\'abord créer un compte dans l\'application, puis soumettre vos documents (pièce d\'identité, véhicule). Notre équipe examinera votre candidature sous 24-48h. Une fois approuvé, vous pourrez commencer à recevoir des commandes.'
        },
        {
            id: 2,
            question: 'Comment sont calculés mes gains ?',
            answer: 'Vos gains sont calculés en fonction du nombre de livraisons effectuées, de la distance parcourue, et des pourboires reçus. Vous pouvez consulter le détail de vos gains dans la section "Historique" de l\'application.'
        },
        {
            id: 3,
            question: 'Quand suis-je payé ?',
            answer: 'Les paiements sont effectués chaque semaine, le vendredi, pour toutes les livraisons de la semaine précédente. Les fonds sont virés directement sur votre compte bancaire enregistré.'
        },
        {
            id: 4,
            question: 'Que faire si j\'ai un problème avec une commande ?',
            answer: 'En cas de problème avec une commande, contactez immédiatement le support via l\'application ou par téléphone. Nous vous aiderons à résoudre le problème et à contacter le client si nécessaire.'
        },
        {
            id: 5,
            question: 'Comment changer ma zone de livraison ?',
            answer: 'Vous pouvez modifier votre zone de livraison dans les paramètres de votre profil. Notez que certaines zones peuvent nécessiter une nouvelle validation de notre équipe.'
        },
        {
            id: 6,
            question: 'L\'application ne fonctionne pas, que faire ?',
            answer: 'Essayez d\'abord de redémarrer l\'application. Si le problème persiste, vérifiez votre connexion internet et assurez-vous d\'avoir la dernière version de l\'app. Contactez le support si le problème continue.'
        }
    ];
...
---
Envoyé depuis l'app Dixie Delivery
            `.trim();

            const mailtoUrl = `mailto:oumzil@gmail.com?subject=${encodeURIComponent(contactForm.subject)}&body=${encodeURIComponent(emailBody)}`;
        ...
        <SafeAreaView className="flex-1 bg-gray-50">
            ...
            <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
                        ...
                        <View key={faq.id}>
                            <TouchableOpacity
                                className={`flex-row items-center justify-between p-4 ${
                                    index < faqData.length - 1 || selectedFAQ === faq.id ? 'border-b border-gray-100' : ''
                                }`}
                ...
                <View className="bg-white mx-4 mt-4 rounded-xl p-4 shadow-sm">
                    ...
                    {/* Issue Categories */}
                    <Text className="text-gray-700 font-medium mb-2">Type de problème</Text>
                    <ScrollView
                        horizontal
                            ...
                            {issueCategories.map((category) => (
                                ...
                                >
                                    <Feather
                                        ...
                                        size={16}
                                        color={contactForm.subject.includes(category.name) ? "#F97316" : "#6B7280"}
                                    />
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => setContactForm({
                            ...contactForm,
                            subject: text
                        })}
                    />
                    ...
                    {/* Email (optional) */}
                    <Text className="text-gray-700 font-medium mb-2">Email de contact (optionnel)</Text>
                    <TextInput
                        className="border border-gray-300 rounded-lg p-3 text-gray-800 mb-4"
